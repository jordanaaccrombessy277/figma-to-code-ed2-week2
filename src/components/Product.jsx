...
function Product({productImg, productPrice, productCurrencyCode, productTitle, cart}) {
  return (
        ...
        <div className="w-full group h-auto relative">
            ...
            <div className="absolute hidden rounded-32 bg-blackopacity23 top-0 w-full h-full group-hover:flex flex-wrap justify-center items-end">
                <div className="flex flex-row gap-1 pb-4">
                    <a href="/" className="uppercase font-jetbrainsmono font-extrabold md:text-sm text-xs flex flex-row gap-1.5 px-3 py-3 bg-white rounded-3xl items-center"> <img src={cart} alt="" /> Add to cart</a>
                    <a href="/" className="uppercase font-jetbrainsmono font-extrabold md:text-sm text-xs px-8 py-3 border border-white text-white rounded-3xl">Buy now</a>
                </div>
            </div>
        </div>
